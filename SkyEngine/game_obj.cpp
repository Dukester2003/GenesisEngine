...
GameObject::GameObject(glm::vec3 pos, glm::vec3 size, glm::vec3 velocity, glm::vec3 rotation, Model objModel) 
: Position(pos), Size(size), Velocity(velocity), Rotation(rotation), Destroyed(false), model(objModel) {}
GameObject::GameObject() 
: Position(0.0f), Size(1.0f), Velocity(0.0f), Rotation(0.0f), Destroyed(false), model() {}
